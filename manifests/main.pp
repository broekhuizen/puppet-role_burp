...
class role_burp::main (
  ...
  $working_dir_recovery_method = $role_burp::yaml::parameters['role_burp::main::working_dir_recovery_method'],
  ...
  class { 'burp':
    ...
    cname                       => $cname,
    directory                   => $directory,
    working_dir_recovery_method => $working_dir_recovery_method,
